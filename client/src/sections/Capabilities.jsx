  ...
  return (
    <section className="relative bg-gradient-to-b from-transparent via-ink-2/80 to-transparent py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <Reveal className="relative mx-auto mt-16 hidden aspect-square max-w-[640px] md:block">
          ...
          {capabilities.map(({ name, icon: Icon }, i) => {
            ...
            return (
              <div
                key={name}
                className="glass liquid absolute flex -translate-x-1/2 -translate-y-1/2 items-center gap-2.5 rounded-full py-2.5 pr-4 pl-3 text-sm whitespace-nowrap"
