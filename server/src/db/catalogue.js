...
export const models = [
  m({ model: 'TS-233-2G', brand: 'QNAP', bays: 2, raid: TWO, network: '1GbE ×1', cpu: 'ARM Cortex-A55', memory: '2 GB (on board)', memoryMax: 'not upgradable', m2Slots: 0, maxDriveTb: 32, warranty: '2 years, extendable to 5', quotePrice: 24000,
    summary: 'An entry 2-bay NAS for home backup, photo libraries and simple file sharing.' }),
  m({ model: 'DS223J', brand: 'Synology', bays: 2, raid: TWO, network: '1GbE ×1', cpu: 'Realtek RTD1619B', memory: '1 GB DDR4', memoryMax: 'not upgradable', m2Slots: 0, maxDriveTb: 24, warranty: '2 years, extendable to 4', quotePrice: 24000,
    summary: 'Synology DSM at its simplest: a quiet 2-bay personal cloud for the home.' }),
  m({ model: 'TS-216G-4G', brand: 'QNAP', bays: 2, raid: TWO, network: '2.5GbE ×1 + 1GbE ×1', cpu: 'ARM Cortex-A55', memory: '4 GB', m2Slots: 0, maxDriveTb: 32, warranty: '2 years, extendable to 5', quotePrice: 29000,
    summary: 'A 2-bay NAS with 2.5GbE for faster transfers at home or in a small office.' }),
  m({ model: 'DS225+', brand: 'Synology', bays: 2, raid: TWO, network: '2.5GbE ×1 + 1GbE ×1', cpu: 'Intel Celeron J4125', memory: '2 GB DDR4', memoryMax: '6 GB', m2Slots: 0, maxDriveTb: 24, warranty: '3 years, extendable to 5', quotePrice: 42000, featured: true,
    summary: 'A capable 2-bay Synology with 2.5GbE and an Intel CPU for media and backups.' }),
  m({ model: 'DS725+', brand: 'Synology', bays: 2, raid: TWO, network: '2.5GbE ×1 + 1GbE ×1', cpu: 'AMD Ryzen R1600', memory: '4 GB DDR4 ECC', memoryMax: '32 GB', m2Slots: 2, maxDriveTb: 24, baysWithExpansion: 7, warranty: '3 years, extendable to 5', quotePrice: 94000,
    summary: 'A compact 2-bay with Ryzen, ECC memory and NVMe slots that expands to 7 bays.' }),
  m({ model: 'TS-433-4G', brand: 'QNAP', bays: 4, raid: ALL, network: '2.5GbE ×1 + 1GbE ×1', cpu: 'ARM Cortex-A55', memory: '4 GB (on board)', memoryMax: 'not upgradable', m2Slots: 0, maxDriveTb: 32, quotePrice: 45000, featured: true, rentable: true,
    summary: 'The most affordable 4-bay route to RAID 5 and RAID 6 protection.' }),
  m({ model: 'TS-462-4G', brand: 'QNAP', bays: 4, raid: ALL, network: '2.5GbE ×1', networkUpgrade: '10GbE via PCIe', cpu: 'Intel Celeron N4505', memory: '4 GB DDR4', memoryMax: '16 GB', m2Slots: 2, maxDriveTb: 32, quotePrice: 57000,
    summary: 'A 4-bay Intel NAS with M.2 slots and a PCIe path to 10GbE.' }),
  m({ model: 'DS425+', brand: 'Synology', bays: 4, raid: ALL, network: '2.5GbE ×1 + 1GbE ×1', cpu: 'Intel Celeron J4125', memory: '2 GB DDR4', memoryMax: '6 GB', m2Slots: 2, maxDriveTb: 24, warranty: '3 years, extendable to 5', quotePrice: 67000, rentable: true,
    summary: 'A 4-bay Synology for photographers and small teams, with NVMe caching.' }),
  m({ model: 'TS-464-8G', brand: 'QNAP', bays: 4, raid: ALL, network: '2.5GbE ×2', networkUpgrade: '10GbE via PCIe', cpu: 'Intel Celeron N5105', memory: '8 GB DDR4', memoryMax: '16 GB', m2Slots: 2, maxDriveTb: 32, baysWithExpansion: 12, quotePrice: 69000, featured: true, rentable: true,
    summary: 'Dual 2.5GbE, 8 GB RAM and room to expand to 12 bays: a strong creator NAS.' }),
  m({ model: 'DS925+', brand: 'Synology', bays: 4, raid: ALL, network: '2.5GbE ×2', cpu: 'AMD Ryzen V1500B', memory: '4 GB DDR4 ECC', memoryMax: '32 GB', m2Slots: 2, maxDriveTb: 24, baysWithExpansion: 9, warranty: '3 years, extendable to 5', quotePrice: 97000, featured: true,
    summary: 'Ryzen, ECC memory and dual 2.5GbE for businesses that want Synology reliability.' }),
  m({ model: 'DS1525+', brand: 'Synology', bays: 5, raid: ALL, network: '2.5GbE ×2', networkUpgrade: '10GbE via E10G22-T1-Mini', cpu: 'AMD Ryzen V1500B', memory: '8 GB DDR4 ECC', memoryMax: '32 GB', m2Slots: 2, maxDriveTb: 24, baysWithExpansion: 15, warranty: '3 years, extendable to 5', quotePrice: 142000, rentable: true,
    summary: 'A 5-bay business platform that scales to 15 drives, with a 10GbE upgrade.' }),
  m({ model: 'TS-664-8G', brand: 'QNAP', bays: 6, raid: ALL, network: '2.5GbE ×2', networkUpgrade: '10GbE via PCIe', cpu: 'Intel Celeron N5095', memory: '8 GB DDR4', memoryMax: '16 GB', m2Slots: 2, maxDriveTb: 32, quotePrice: 87000,
    summary: 'Six bays for large media archives at a low cost per bay.' }),
  m({ model: 'TS-832PX-4G', brand: 'QNAP', bays: 8, raid: ALL, network: '10GbE SFP+ ×2 + 2.5GbE ×2', cpu: 'Annapurna Labs AL-324', memory: '4 GB DDR4', memoryMax: '16 GB', m2Slots: 0, maxDriveTb: 32, baysWithExpansion: 16, quotePrice: 108000,
    summary: 'Eight bays with dual 10GbE SFP+ built in, for fast shared storage.' }),
  m({ model: 'TS-873A-8G', brand: 'QNAP', bays: 8, raid: ALL, network: '2.5GbE ×2', networkUpgrade: '5/10GbE via PCIe Gen3', cpu: 'AMD Ryzen V1500B', memory: '8 GB DDR4', memoryMax: '64 GB', m2Slots: 2, maxDriveTb: 32, baysWithExpansion: 16, quotePrice: 130000, featured: true, rentable: true,
    summary: 'An 8-bay Ryzen workhorse for virtualization, multi-editor video and heavy workloads.' }),
  m({ model: 'DS1825+', brand: 'Synology', bays: 8, raid: ALL, network: '2.5GbE ×2', networkUpgrade: 'up to 25GbE via PCIe', cpu: 'AMD Ryzen V1500B', memory: '8 GB DDR4 ECC', memoryMax: '32 GB', m2Slots: 2, maxDriveTb: 24, baysWithExpansion: 18, warranty: '3 years, extendable to 5', quotePrice: 180000,
